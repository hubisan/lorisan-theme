...
(let ((class '((class color) (min-colors 89)))
      ...
      (yellow2-light "#D9C78C")
      (yellow2 "#E4AF00")
      (yellow2-bright "#FFC811")
      (yellow-light "#d4ca7d")
      (yellow "#c6b954")
      ...
      (magenta-light "#ffb1d8")
      (magenta "#FF85C2")
      (magenta-bright "#FF5AAC")
      (magenta-darker "#9D3469")
      (magenta-dark "#71264B")
      (magenta-darkest "#3D0722")
      (white "#FFF")
      (paren2 "#7070EF")
      (paren3 "#AD5AD6")
      (paren4 "#C655A1")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-builtin-face ((,class (:foreground ,turquoise-bright))))
   `(font-lock-comment-delimiter-face ((,class (:foreground ,blue3 :slant italic))))
   `(font-lock-comment-face ((,class (:foreground ,blue3 :slant italic))))
   ...
   `(font-lock-function-name-face ((,class (:foreground ,pink-bright))))
   `(font-lock-keyword-face ((,class (:foreground ,yellow2))))
   ...
   `(flycheck-fringe-warning ((,class (:background ,yellow2 :foreground ,yellow-darkest))))
   ...
   `(org-level-2 ((,class (:foreground ,blue3-bright))))
   ...
   ;; outline
   `(outline-1 ((,class (:slant normal :foreground "#9d98ff" :background ,blue-darkest :underline (:style line :color ,grey-dark)))))
   `(outline-2 ((,class (:slant normal :foreground "#9d98ff" :underline (:style line :color ,grey-dark)))))
   `(outline-3 ((,class (:slant normal :foreground "#9d98ff" :underline (:style line :color ,grey-dark)))))
   `(outline-4 ((,class (:slant normal :foreground "#9d98ff" :underline (:style line :color ,grey-dark)))))
