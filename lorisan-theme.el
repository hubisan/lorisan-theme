...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-block-begin-line ((,class (:foreground ,indigo-darker- :background ,background2 :extend t))))
   `(org-block-end-line ((,class (:foreground ,indigo-darker- :background ,background2 :extend t))))
