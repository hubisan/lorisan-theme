...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(org-level-1 ((,class (:foreground ,white :weight bold))))
   `(org-level-2 ((,class (:foreground ,white :weight bold))))
   `(org-level-3 ((,class (:foreground ,white :weight bold))))
   `(org-level-4 ((,class (:foreground ,white :weight bold))))
   `(org-level-5 ((,class (:foreground ,white :weight bold))))
   `(org-level-6 ((,class (:foreground ,white :weight bold))))
   `(org-level-7 ((,class (:foreground ,white :weight bold))))
   `(org-level-8 ((,class (:foreground ,white :weight bold))))
