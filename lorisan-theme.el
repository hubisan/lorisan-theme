...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(show-paren-match ((,class (:weight normal :foreground ,indigo-light :background ,indigo-dark :underline t))))
   ...
   `(org-headline-done ((,class (:foreground ,indigo-dark :weight bold))))
   ...
   `(org-special-keyword ((,class (:foreground ,grey-darker))))
   ...
   ;;;; outline
   `(outline-1 ((,class (:foreground ,indigo-light :weight bold))))
   `(outline-2 ((,class (:foreground ,indigo-light :weight bold))))
   `(outline-3 ((,class (:foreground ,indigo-light :weight bold :slant italic))))
   `(outline-4 ((,class (:foreground ,indigo-light :slant italic))))
   `(outline-5 ((,class (:foreground ,indigo-light :slant italic))))
   `(outline-6 ((,class (:foreground ,indigo-light :slant italic))))
   `(outline-7 ((,class (:foreground ,indigo-light :slant italic))))
   `(outline-8 ((,class (:foreground ,indigo-light :slant italic))))
   `(outline-9 ((,class (:foreground ,indigo-light :slant italic))))
