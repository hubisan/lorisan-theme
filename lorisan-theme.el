...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;;;; evil-goggles
   `(evil-goggles-default-face ((,class (:background ,indigo-darkest :foreground ,indigo-bright))))
   `(evil-goggles-change-face ((,class (:background ,fulvous-darkest :foreground ,fulvous-bright))))
   `(evil-goggles-commentary-face ((,class (:inherit evil-goggles-default-face))))
   `(evil-goggles-delete-face ((,class (:background ,wine-darkest :foreground ,wine-bright))))
   ...
   `(evil-goggles-paste-face ((,class (:background ,mint-darkest :foreground ,mint-bright))))
