...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;;;; outline
   `(outline-1 ((,class (:foreground ,mint-bright :weight bold))))
   `(outline-2 ((,class (:foreground ,mint-bright))))
   `(outline-3 ((,class (:foreground ,mint-bright :slant italic))))
   `(outline-4 ((,class (:foreground ,mint-bright :slant italic))))
   `(outline-5 ((,class (:foreground ,mint-bright :slant italic))))
   `(outline-6 ((,class (:foreground ,mint-bright :slant italic))))
   `(outline-7 ((,class (:foreground ,mint-bright :slant italic))))
   `(outline-8 ((,class (:foreground ,mint-bright :slant italic))))
   `(outline-9 ((,class (:foreground ,mint-bright :slant italic))))
