...
;;      (lime-brightest "#E1FF4D")
  ...
  (custom-theme-set-faces
   ...
   `(helm-source-header ((,class (:background ,magenta-darkest, :foreground ,pink-bright, :underline nil, :weight bold))))
   ...
   `(jabber-roster-user-away ((,class (:foreground ,coquelicot))))
   ...
   `(org-scheduled ((,class (:foreground ,amber-darker))))
   `(org-scheduled-previously ((,class (:foreground ,coquelicot))))
   `(org-scheduled-today ((,class (:foreground ,blue))))
   `(org-special-keyword ((,class (:foreground ,amber-darker))))
   ...
   `(org-warning ((,class (:foreground ,amber))))
