...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(show-paren-match ((,class (:weight normal :foreground ,background :background ,indigo-darker :underline nil))))
   ...
   `(org-agenda-date-today ((,class (:foreground ,mint))))
   ...
   `(org-scheduled ((,class (:foreground ,indigo-light))))
   `(org-scheduled-previously ((,class (:foreground ,indigo-light))))
